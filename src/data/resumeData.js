  ...
  pages: [
    {
      ...
      list: [
        {
          name: 'strong',
          list: ['React', 'RxJS', 'DraftJS', 'Backbone', 'jQuery', 'JavaScript', 'HTML/CSS', 'Linux']
        },
        {
          name: 'experienced',
    ...
    },
    {
      ...
      list: [
        ...
        },
        {
          ...
          location: 'Olympia, WA',
          date: 2006,
          description: 'BS & BA with a concentration in chemistry. Substantial coursework in biology.'
        }
      ],
    },
    {
...
fs.writeFile('../../public/resume.json', JSON.stringify(resume), () => {process.exit()})
